...
public class UsuarioEntity {
    ...
    public UsuarioEntity(int ID_USER, String USERNAME, String PASSWORD, String NAME, String SURENAME1, String SURENAME2, String PHONE, String MAIL, int ROLES_ID_ROL) {
